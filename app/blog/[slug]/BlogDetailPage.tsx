...
export default function BlogDetailPage() {
  ...
  if (!data || !data.article) return <div className="text-center py-20 text-red-500 font-medium text-sm">Artikel tidak ditemukan.</div>;
    ...
    <div className="min-h-screen bg-white py-8 px-4 md:px-16">
      <div className="max-w-5xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 space-y-6 flex flex-col">
          ...
          {/* AREA FOTO UTAMA / PEMUTAR VIDEO YOUTUBE KONDISIONAL */}
