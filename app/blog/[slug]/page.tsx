...
import BlogDetailPage from './BlogDetailPage'; // Memanggil file detail berita lama yang baru diubah namanya
  ...
  try {
    ...
    return {
      ...
      openGraph: {
        ...
        url: `https://www.indonesiamengaji.net/blog/${slug}`, // 🚀 FIXED: Menuju URL domain indonesiamengaji.net/blog/
