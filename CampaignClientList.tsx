// app/program/CampaignClientList.tsx
'use client';
...
export default function CampaignClientList({ initialData }: CampaignClientListProps) {
  ...
  useEffect(() => {
    // Tetap jalankan fetch real-time di background agar nominal donasi selalu up-to-date
